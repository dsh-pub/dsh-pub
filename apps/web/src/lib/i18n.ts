...
export const copy = {
  en: {
    ...
    communityReviewNotice:
      'Community records verify a pinned bundle contract and committed runtime files. They are not a security audit or an official DSH endorsement.',
    communityPlugins: 'Community additions',
    communityPluginsBody:
      'Installable Git bundles discovered through the dsh-plugin topic and admitted from pinned, reviewed source contracts.',
    version: 'Version',
    license: 'License',
    profiles: 'Profiles',
    ...
    countCommunity: 'community reviewed',
    language: '中文',
  },
  zh: {
    ...
    communityReviewNotice:
      '社区条目仅核对固定版本的组合包契约与已提交运行产物，不等于安全审计，也不代表 DSH 官方背书。',
    communityPlugins: '社区新增插件',
    communityPluginsBody:
      '从 dsh-plugin Topic 发现、按固定 commit 与源码契约人工核对后收录的可安装 Git 组合包。',
    version: '版本',
    license: '许可证',
    profiles: '所属 Profile',
    distribution: '分发方式',
